...
with plt.style.context('../IOP_large.mplstyle2'):
    ...
    #V/t = -10
    data_n13_VNEG10a2 = np.loadtxt("M26F13VNEG10.0a2Probs.dat")
    data_n14_VNEG10a2 = np.loadtxt("M28F14VNEG10.0a2Probs.dat")
    
    #data_n13_VNEG10a5 = np.loadtxt("M26F13VNEG10.0a5Probs.dat")
    #data_n14_VNEG10a5 = np.loadtxt("M28F14VNEG10.0a5Probs.dat")
    
    data_n13_VNEG10a10 = np.loadtxt("M26F13VNEG10.0a10Probs.dat")
    data_n14_VNEG10a10 = np.loadtxt("M28F14VNEG10.0a10Probs.dat")
       
    #V/t = -1.5
    data_n13_VNEG1d5a2 = np.loadtxt("M26F13VNEG1.5a2Probs.dat")
    data_n14_VNEG1d5a2 = np.loadtxt("M28F14VNEG1.5a2Probs.dat")
    
    data_n13_VNEG1d5a5 = np.loadtxt("M26F13VNEG1.5a5Probs.dat")
    data_n14_VNEG1d5a5 = np.loadtxt("M28F14VNEG1.5a5Probs.dat")
    
    data_n13_VNEG1d5a10 = np.loadtxt("M26F13VNEG1.5a10Probs.dat")
    data_n14_VNEG1d5a10 = np.loadtxt("M28F14VNEG1.5a10Probs.dat")
    
    #V/t = 10
    data_n13_V10a2 = np.loadtxt("M26F13V10.0a2Probs.dat")
    data_n14_V10a2 = np.loadtxt("M28F14V10.0a2Probs.dat")
    
    #data_n13_V10a5 = np.loadtxt("M26F13V10.0a5Probs.dat")
    #data_n14_V10a5 = np.loadtxt("M28F14V10.0a5Probs.dat")
    
    data_n13_V10a10 = np.loadtxt("M26F13V10.0a10Probs.dat")
    data_n14_V10a10 = np.loadtxt("M28F14V10.0a10Probs.dat")
    ...
    plt.savefig('probabilities_N15N16_VNEG1.5_log.pdf', transparent=False)
