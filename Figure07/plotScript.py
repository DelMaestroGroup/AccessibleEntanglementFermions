...
with plt.style.context('../IOP_large.mplstyle'):
    ...
    ax4.plot(KvsV[:,0]/np.pi**2/2*np.log(y), np.exp((s1VNEG1d5M28lN[1:]-s1opVNEG1d5M28lN[1:] -0.5-np.log(2*np.pi)/2.0)*2.0) , '.', label=r'$\mathcal{B}_{1}{\rm{e}}^{2\Delta S_{2}}$', linewidth = 1, color='#4173b3',markeredgewidth='0.5',markersize=9,mfc= blue[3],zorder=10)
