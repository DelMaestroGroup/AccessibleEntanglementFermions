...
#    ax1.set_xlim(-energies_M22N11[-1], -energies_M22N11[0])
    ...
    ax2.tick_params(axis='both', which='both', left=False, top=False,labelleft=False, direction='in')
...
#    ax4.set_xlim(-energies_M22N11[-1], -energies_M22N11[0])
    ...
    ax5.tick_params(axis='both', which='both', left=False, top=False,labelleft=False, direction='in')
...
#    ax5.set_xlim(energies_M22N11[0], energies_M22N11[-1])
    ...
    #plt.savefig('operationalEntanglementEntropies.pdf')
    plt.show()
