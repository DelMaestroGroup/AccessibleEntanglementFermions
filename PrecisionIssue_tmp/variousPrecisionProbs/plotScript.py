...
with plt.style.context('../IOP_large.mplstyle2'):
    ...
    #V/t = +-1.5
    data_n15_V1d5a2 = np.loadtxt("M10F5V1.5a2Probs_toK.dat")
    data_n16_V1d5a2 = np.loadtxt("M12F6V1.5a2Probs_toK.dat")
    data_n15_VNEG1d5a2 = np.loadtxt("M10F5VNEG1.5a2Probs_toK.dat")
    data_n16_VNEG1d5a2 = np.loadtxt("M12F6VNEG1.5a2Probs_toK.dat")
    
    #V/t = +- 1.0
    data_n15_V1a2 = np.loadtxt("M10F5V1.0a2Probs_toK.dat")
    data_n16_V1a2 = np.loadtxt("M12F6V1.0a2Probs_toK.dat")
    data_n15_VNEG1a2 = np.loadtxt("M10F5VNEG1.0a2Probs_toK.dat")
    data_n16_VNEG1a2 = np.loadtxt("M12F6VNEG1.0a2Probs_toK.dat")

    #V/t = 0
    data_n15_V0a2 = np.loadtxt("M10F5V0.0a2Probs_toK.dat")
    data_n16_V0a2 = np.loadtxt("M12F6V0.0a2Probs_toK.dat")
    ...
    ax1.xaxis.set_ticks(np.arange(0, 5.1, 1))
    ax1.set_yscale('log')
    ax1.set_ylabel(r'$(P_{n,2,K})^{K}$')
    #ax1.set_ylim(1E-11,1E+04)
    ax1.text(4.35,1E-01,r'$N=15$')
