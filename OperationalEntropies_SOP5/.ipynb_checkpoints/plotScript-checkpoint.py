...
#Top Plot: One Particle Entanglement entropy dependence on the interaction potential
    ...
    #11 particles
    datFileNEG_M22N11 = 'EOPP22F11l11NEG.dat'
    dataNEG_M22N11 = np.loadtxt(datFileNEG_M22N11)
    
    datFile_M22N11 = 'EOPP22F11l11.dat'
    data_M22N11 = np.loadtxt(datFile_M22N11)
    
    #13 particles

    datFileNEG_M26N13 = 'EOPP26F13l13NEG.dat'
    dataNEG_M26N13 = np.loadtxt(datFileNEG_M26N13)
    
    datFile_M26N13 = 'EOPP26F13l13.dat'
    data_M26N13 = np.loadtxt(datFile_M26N13)
    
    #15 particles

    datFileNEG_M30N15 = 'EOPP30F15l15NEG.dat'
    dataNEG_M30N15 = np.loadtxt(datFileNEG_M30N15)
    
    datFile_M30N15 = 'EOPP30F15l15.dat'
    ...
    s2NEG_M22N11 = dataNEG_M22N11[:,5]
    s2_M22N11 = data_M22N11[:,5]
    ...
    s2NEG_M30N15 = dataNEG_M30N15[:,5]
    s2_M30N15 = data_M30N15[:,5]
...
#Bottom Plot: Operational entanglement entropies for even number of particles
    ...
    datFileNEG_M24N12 = 'EOPA24F12l12NEG.dat'
    dataNEG_M24N12 = np.loadtxt(datFileNEG_M24N12)
    
    datFile_M24N12 = 'EOPA24F12l12.dat'
    data_M24N12 = np.loadtxt(datFile_M24N12)
    
    #14 particles
    
    datFileNEG_M28N14 = 'EOPA28F14l14NEG.dat'
    dataNEG_M28N14 = np.loadtxt(datFileNEG_M28N14)
    
    datFile_M28N14 = 'EOPA28F14l14.dat'
    data_M28N14 = np.loadtxt(datFile_M28N14)
    
    #16 particles
    datFileNEG_M32N16 = 'EOPA32F16l16NEG.dat'
    dataNEG_M32N16 = np.loadtxt(datFileNEG_M32N16)
    
    datFile_M32N16 = 'EOPA32F16l16.dat'
    ...
    s2NEG_M24N12 = dataNEG_M24N12[:,5]
    s2_M24N12 = data_M24N12[:,5]
    ...
    #plt.savefig('operationalEntanglementEntropies.pdf', transparent=False)
    plt.show()
